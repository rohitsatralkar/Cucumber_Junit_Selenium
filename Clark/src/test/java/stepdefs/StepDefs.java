...
public class StepDefs{
	...
	public void i_fill_in_the_following_details_and_continue(DataTable dataTable) {
		List<Map<String, String>> list = dataTable.asMaps(String.class, String.class);
	    utility.waitForEle(10, personalInfo.onPersonalInfoPage());
	...
	public void i_verify_the_details_on_the_verification_page_and_click_on() {
		utility.waitForEle(10, personalInfo.overviewPage());
